#ifndef SIMON_WORLD_H_
#define SIMON_WORLD_H_
...
class NetworkHaptics : public barrett::systems::SingleIO<barrett::math::Vector<8>::type, barrett::math::Vector<8>::type > {
        //BARRETT_UNITS_FIXED_SIZE_TYPEDEFS;
        BARRETT_UNITS_TYPEDEFS(8);

public:
        static const int SIZE_OF_MSG = 8 * sizeof(double);
