...
#ifndef TUPLE_TRAITS_H_
#define TUPLE_TRAITS_H_
...
//template<> struct Traits<boost::tuples::null_type> {
//	typedef boost::tuples::null_type parameter_type;
...
//
//	static boost::tuples::null_type unserialize(pointer_type source) {
